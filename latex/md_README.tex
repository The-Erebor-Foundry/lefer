...
This library offers a single function for each part ({\ttfamily lefer\+::even\+\_\+spaced\+\_\+curves()} and {\ttfamily lefer\+::non\+\_\+overlapping\+\_\+curves()}). So, if you want to draw curves that do not overlap each other, but you do not care about how much far they are from each other, you probably want to use the {\ttfamily lefer\+::non\+\_\+overlapping\+\_\+curves()} function. Otherwise, you use the {\ttfamily lefer\+::even\+\_\+spaced\+\_\+curves()}.

Both functions return a {\ttfamily std\+::vector} of {\ttfamily lefer\+::\+Curve} objects. Each {\ttfamily lefer\+::\+Curve} object represents a curve that was drawn into the flow field.\hypertarget{md_README_autotoc_md4}{}\doxysection{A minimal example}\label{md_README_autotoc_md4}
...
\DoxyCodeLine{}
\DoxyCodeLine{lefer::FlowField flow\_field\_obj = lefer::FlowField(flow\_field, flow\_field\_width);}
\DoxyCodeLine{lefer::DensityGrid density\_grid = lefer::DensityGrid(flow\_field\_width, flow\_field\_height, d\_sep, 2000);}
\DoxyCodeLine{    }
\DoxyCodeLine{\textcolor{keywordtype}{double} x\_start = 45.0;}
\DoxyCodeLine{\textcolor{keywordtype}{double} y\_start = 24.0;}
\DoxyCodeLine{std::vector<lefer::Curve> curves = lefer::even\_spaced\_curves(}
